...
// This is used for registering something. It is used in cases that retuires
// a curcular references.
...
type Prober interface {
	...
	// This is required because it needs to get the manager's reference to access
	// agent spec and status.
	Registerer[AgentManager]
...
type DirectiveGenerator interface {
	...
	// This is required because it needs to get the manager's reference to access
	// generator spec and status.
	Registerer[GeneratorManager]
